...
module Syntax.Grammar.Lex where
  ...
  b "R" 21
    (b "/" 11
       ...
       (b ">" 16
          ...
          (b "Double" 19 (b "Bool" 18 (b ">=" 17 N N) N) (b "L" 20 N N))))
    (b "or" 32
       (b "fst" 27
          (b "else" 24
             (b "cos" 23 (b "and" 22 N N) N) (b "false" 26 (b "exp" 25 N N) N))
          (b "left" 30 (b "lam" 29 (b "if" 28 N N) N) (b "match" 31 N N)))
       (b "sqrt" 37
          (b "sin" 35 (b "right" 34 (b "rand()" 33 N N) N) (b "snd" 36 N N))
          (b "{" 40 (b "true" 39 (b "then" 38 N N) N) (b "}" 41 N N))))
  where
  b s n = B bs (TS bs n)
    where
    bs = s
